...
for next_func in one_num_funcs
    ...
    $stack_depth = 0
    puts next_func.name
    puts "length : " + next_func.call(60).to_s.length.to_s
    puts "called : " + $accm.to_s
    puts "depth : " + ($stack_depth - caller.length).to_s
    puts "----------"
end
for next_func in hanois
    ...
    $stack_depth = 0
    puts next_func.name
    puts "length :" + next_func.call(10).length.to_s
    puts "called :" + $accm.to_s
    puts "depth : " + ($stack_depth - caller.length).to_s
    puts "----------"
end
for next_func in parts
    ...
    $stack_depth = 0
    puts next_func.name
    puts "length :" + next_func.call(20, 8).length.to_s
    puts "called :" + $accm.to_s
    puts "depth : " + ($stack_depth - caller.length).to_s
    puts "----------"
end